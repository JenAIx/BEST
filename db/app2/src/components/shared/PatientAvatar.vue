...
const patientColor = computed(() => {
  const resolvedGender = props.patient.SEX_RESOLVED?.toLowerCase() || props.patient.sexResolved?.toLowerCase()
  const sexCode = props.patient.SEX_CD?.toUpperCase() || props.patient.sexCode?.toUpperCase()
