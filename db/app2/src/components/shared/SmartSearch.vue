<template>
    <div class="smart-search">
        <!-- Search Input -->
        <q-input ref="searchInputRef" v-model="searchQuery" dense outlined
            placeholder="Search patients: P001, John Doe..." class="smart-search__input" bg-color="grey-1"
            @focus="onFocus" @blur="onBlur" @keyup.enter="onEnterSearch" @keyup.escape="clearSearch">
            ...
            <template v-slot:append>
                ...
                <q-btn v-if="searchQuery" flat round dense icon="arrow_forward" size="sm" color="primary"
                    @click="onEnterSearch">
        ...
        <div v-if="showSearchOverlay" class="smart-search__overlay" @click="clearSearch">
            <div class="smart-search__results" @click.stop>
                ...
                <div v-else-if="searchResults.length > 0" class="q-pa-md">
                    ...
                    <q-list separator>
                        <q-item v-for="patient in searchResults" :key="patient.id" clickable v-ripple
                            @click="selectPatient(patient)" class="search-result-item">
                            ...
                            <q-item-section>
                                ...
                                <q-item-label caption class="text-grey-6">
                                    ID: {{ patient.patientId }} • DOB: {{ formatDate(patient.dateOfBirth) }}
                                </q-item-label>
                ...
                <div v-else-if="searchQuery && !isSearching" class="text-center q-pa-xl">
                    ...
                    <div class="text-grey-7">
                        Try searching by patient ID (P001) or name (John Doe)
                    </div>
                ...
                <div v-else class="text-center q-pa-xl">
                    ...
                    <div class="text-grey-7 q-mb-md">
                        Start typing to search for patients by:
                    </div>
...
const selectPatient = (patient) => {
    ...
    router.push({ path: `/patient/${patient.patientId}` })
    clearSearch()
    $q.notify({
        type: 'positive',
        message: `Selected patient: ${patient.firstName} ${patient.lastName}`,
        position: 'top'
    })
}
