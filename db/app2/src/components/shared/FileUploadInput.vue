<template>
  <div class="file-upload-input">
    ...
    >
      <!-- File Input (Hidden) -->
      <input ref="fileInput" type="file" :accept="acceptedTypes" @change="handleFileSelect" style="display: none" />
      ...
      <div v-else class="selected-file-display">
        <div class="row items-center q-gutter-md">
          ...
          <div class="col">
            ...
            <div class="text-caption text-grey-6">{{ formatFileSize(selectedFile.size) }} • {{ getFileExtension(selectedFile.name) }}</div>
          </div>
          <div class="col-auto">
