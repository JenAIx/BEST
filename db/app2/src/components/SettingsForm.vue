<template>
    <div>
        <q-form @submit="onSubmit" class="q-gutter-md">
            <!-- User Name Field -->
            <div>
                <q-input v-model="formData.name" label="Full Name" outlined dense
                    :rules="[val => !!val || 'Name is required']" @update:model-value="onFieldChange" />
            </div>
            ...
            <div class="q-mt-lg">
                ...
                <q-btn color="secondary" label="Reset Password" outline @click="onResetPassword"
                    :loading="isResetting" />
