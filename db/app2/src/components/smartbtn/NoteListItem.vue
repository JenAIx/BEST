<template>
  <q-item class="note-list-item">
    <q-item-section>
      ...
      <q-item-label caption>
        <div class="row items-center q-gutter-xs">
          ...
          <q-chip v-if="contextTarget" dense size="sm" clickable :icon="contextTarget.icon" color="blue-1" text-color="primary" @click.stop="$emit('open-context', contextTarget)">
            {{ contextTarget.label }}
    ...
    <q-item-section v-if="!compact" side>
