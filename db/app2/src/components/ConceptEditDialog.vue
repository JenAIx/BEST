<template>
    <AppInputDialog v-model="dialogVisible" title="Edit Concept" ok-label="Save Changes" cancel-label="Cancel"
        :loading="isSaving" :disable-ok="!isFormValid || !hasChanges" @ok="onSubmit" @cancel="onCancel" size="lg">
        <q-form @submit.prevent="onSubmit" class="q-gutter-md">
            ...
            <div class="row q-gutter-sm">
                ...
                <div class="col">
                    <q-input v-model="formData.conceptCode" label="Concept Code" outlined dense readonly
                        hint="Concept code cannot be changed" />
                </div>
            </div>
            ...
            <!-- Value Type Field -->
            <q-select v-model="formData.valueType" label="Value Type" outlined dense :options="valueTypeOptions"
            ...
            <q-select v-model="formData.sourceSystem" label="Source System" outlined dense
                :options="sourceSystemOptions" @update:model-value="onFieldChange"
