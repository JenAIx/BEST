    ...
    <q-card class="full-height">
        <q-card-section class="full-height">
            ...
            <div v-else class="q-gutter-md">
                <q-select v-model="editForm.gender" :options="genderOptions" label="Gender" outlined dense emit-value
                    map-options />
                <q-select v-model="editForm.status" :options="statusOptions" label="Vital Status" outlined dense
...
const loadOptions = async () => {
    try {
        ...
        const conceptsToPreload = [
            props.patient.SEX_CD,
            props.patient.VITAL_STATUS_CD
        ].filter(Boolean)
