    ...
    <q-dialog v-model="showDialog" persistent>
        <q-card style="min-width: 600px; max-width: 800px;">
            ...
            <q-card-section>
                ...
                <q-form @submit="handleSubmit" class="q-gutter-md">
                    ...
                    <div class="row q-gutter-md">
                        <div class="col">
                            <q-input v-model="formData.PATIENT_CD" label="Patient ID *" outlined dense
                                :rules="[val => !!val || 'Patient ID is required', validatePatientId]" clearable
                                placeholder="e.g., P001, PAT-2024-001">
                                <template v-slot:prepend>
                                    <q-icon name="badge" />
                                </template>
                                <template v-slot:append>
                                    <q-btn flat round dense icon="auto_awesome" color="primary"
                                        @click="generatePatientId" size="sm">
                        ...
                        <div class="col">
                            <q-input v-model="patientName" label="Patient Name" outlined dense clearable
                    ...
                    <div class="row q-gutter-md">
                        <div class="col">
                            <q-input v-model="formData.BIRTH_DATE" type="date" label="Birth Date" outlined dense
                                clearable @blur="onBirthDateBlur">
                                <template v-slot:prepend>
                                    <q-icon name="cake" />
                                </template>
                            </q-input>
                        ...
                        <div class="col">
                            <q-input v-model="formData.AGE_IN_YEARS" type="number" label="Age (Years)" outlined dense
                                min="0" max="150" clearable @blur="onAgeBlur">
                                <template v-slot:prepend>
                    ...
                    <div class="row q-gutter-md">
                        <div class="col">
                            <q-select v-model="formData.SEX_CD" :options="genderOptions" label="Gender" outlined dense
                        ...
                        <div class="col">
                            <q-select v-model="formData.VITAL_STATUS_CD" :options="vitalStatusOptions"
                                label="Vital Status" outlined dense clearable emit-value map-options>
                                <template v-slot:prepend>
                    ...
                    <div class="row q-gutter-md">
                        <div class="col">
                            <q-select v-model="formData.LANGUAGE_CD" :options="languageOptions" label="Language"
                        ...
                        <div class="col">
                            <q-select v-model="formData.RACE_CD" :options="raceOptions" label="Race" outlined dense
                                clearable emit-value map-options>
                                <template v-slot:prepend>
                    ...
                    <div class="row q-gutter-md">
                        <div class="col">
                            <q-select v-model="formData.MARITAL_STATUS_CD" :options="maritalStatusOptions"
                                label="Marital Status" outlined dense clearable emit-value map-options>
                                <template v-slot:prepend>
                        ...
                        <div class="col">
                            <q-select v-model="formData.RELIGION_CD" :options="religionOptions" label="Religion"
                                outlined dense clearable emit-value map-options>
                                <template v-slot:prepend>
                                    <q-icon name="church" />
                                </template>
                    ...
                    <div class="row q-gutter-md">
                        <div class="col">
                            <q-input v-model="formData.STATECITYZIP_PATH" label="Location" outlined dense clearable
                        ...
                        <div class="col">
                            <q-input v-model="formData.SOURCESYSTEM_CD" label="Source System" outlined dense clearable
                    ...
                    <div v-if="showDeathDate" class="row q-gutter-md">
                        <div class="col">
                            <q-input v-model="formData.DEATH_DATE" type="date" label="Death Date" outlined dense
                                clearable>
                                <template v-slot:prepend>
                    ...
                    <!-- Notes -->
                    <q-input v-model="patientNotes" label="Notes" type="textarea" outlined rows="3" clearable
            ...
            <q-card-actions align="right" class="q-pa-md">
                ...
                <q-btn unelevated label="Create Patient" color="primary" icon="person_add" @click="handleSubmit"
