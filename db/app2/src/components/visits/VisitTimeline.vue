    ...
    <div class="timeline-view">
        <div class="timeline-container">
            ...
            <div v-else class="timeline-list">
                <VisitTimelineItem v-for="(visit, index) in sortedVisits" :key="visit.id" :visit="visit"
                    :is-last="index === sortedVisits.length - 1" :is-selected="selectedVisit?.id === visit.id"
                    @select="selectVisit" @edit="editVisit" @duplicate="duplicateVisit" @delete="deleteVisit" />
            </div>
        </div>
