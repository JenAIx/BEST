<template>
  <AppDialog v-model="dialogModel" title="Export Patient Data" subtitle="Choose export format and options" size="md" :persistent="false" :show-actions="false" :show-close="true" @close="onCancel">
    <div class="export-dialog">
      ...
      <div class="format-selection q-mb-lg">
        ...
        <q-option-group v-model="selectedFormat" :options="formatOptions" color="primary" type="radio" class="format-options" />
      </div>
      ...
      <div class="export-options q-mb-lg">
        ...
        <div class="row q-col-gutter-md">
          <div class="col-6">
            <q-checkbox v-model="includeVisits" label="Visits" color="primary" :disable="!canToggleVisits" />
          </div>
          <div class="col-6">
            <q-checkbox v-model="includeObservations" label="Observations" color="primary" :disable="!canToggleObservations" />
          </div>
        </div>
      ...
      <div class="row q-col-gutter-sm">
        ...
        <div class="col">
          <q-btn color="primary" label="Export" icon="download" class="full-width" :loading="isExporting" @click="onExport" />
        </div>
      </div>
    </div>
  </AppDialog>
...
const formatDescription = computed(() => {
  const descriptions = {
    csv: {
      ...
      features: ['Compatible with Excel, Google Sheets', 'Two-row header system', 'Concept code mapping', 'Flat data structure'],
    },
    json: {
      title: 'JSON Export',
      description: 'Exports data as structured JSON with complete metadata and hierarchical organization.',
      features: ['Hierarchical data structure', 'Complete metadata included', 'Programming-friendly format', 'Preserves all relationships'],
    },
    hl7: {
      ...
      features: ['Healthcare standard compliance', 'Clinical document format', 'Interoperability focused', 'Digital signature support'],
    },
  }
