    ...
    <q-card style="min-width: 500px; max-width: 600px">
      ...
      <q-card-section class="q-pa-md">
        <q-form @submit="onSave" class="q-gutter-md">
          <q-input v-model="formData.CODE_CD" outlined dense label="Code *" :rules="[(val) => !!val || 'Code is required']" hint="Unique identifier for the CQL rule" />

          <q-input v-model="formData.NAME_CHAR" outlined dense label="Name *" :rules="[(val) => !!val || 'Name is required']" hint="Descriptive name for the CQL rule" />

          <q-input v-model="formData.CQL_BLOB" outlined dense label="Description" hint="Optional description of what this rule does" />
