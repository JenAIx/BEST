 ...
 * Complete database schema with all core tables, indexes, and initial structure
 * Consolidates: 001-initial-schema, 002-current-schema, 003-add-note-fact-columns
 */

export const coreSchema = {
  name: '001-core-schema',
  description: 'Complete core database schema with all tables and indexes',
  sql: `
    ...
    -- NOTE_FACT - Clinical notes and documentation (with all required columns)
    CREATE TABLE IF NOT EXISTS NOTE_FACT (
      ...
      UPLOAD_ID NUMERIC,
      FOREIGN KEY (PATIENT_NUM) REFERENCES PATIENT_DIMENSION(PATIENT_NUM),
      FOREIGN KEY (ENCOUNTER_NUM) REFERENCES VISIT_DIMENSION(ENCOUNTER_NUM),
    ...
    CREATE INDEX IF NOT EXISTS idx_note_category ON NOTE_FACT(CATEGORY_CHAR);
  `,
}
