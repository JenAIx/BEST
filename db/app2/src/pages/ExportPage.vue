<template>
    <q-page class="export-page">
            ...
            <q-card>
                <q-card-section>
                    ...
                    <div class="text-caption text-grey-6 q-mt-xs">
                        Select patients and configure export options
                    </div>
                </q-card-section>
                ...
                <q-card-section>
                    <div class="row q-col-gutter-md items-end">
                        <div class="col-12 col-md-4">
                            <q-input v-model="filters.search" label="Search by name or Patient ID" outlined dense
                                clearable debounce="300" placeholder="Search patients...">
                        ...
                        <div class="col-12 col-md-3">
                            <q-select v-model="filters.gender" :options="genderOptions" label="Gender" outlined dense
                                clearable emit-value map-options />
                        </div>
                        <div class="col-12 col-md-3">
                            <q-select v-model="filters.status" :options="statusOptions" label="Vital Status" outlined
                    ...
                    <div class="row q-mt-sm">
                        <div class="col-12">
                            <div class="text-caption text-grey-6 q-px-sm">
                                ...
                                <span class="q-mr-md">Total: <strong>{{ totalPatients }}</strong></span>
                                <span v-if="hasActiveFilters">• Filtered: <strong>{{ pagination.rowsNumber
                                        }}</strong></span>
                ...
                <q-card-section v-if="selectedPatients.length > 0" class="q-pt-none">
                    <div class="row q-col-gutter-sm items-center">
                        <div class="col-auto">
                            <q-btn color="primary" icon="download" label="Export Selected"
                                @click="showExportDialog = true" :loading="isExporting" />
                        </div>
                        <div class="col-auto">
                ...
                <q-card-section class="q-pa-none">
                    <q-table :rows="tableData" :columns="tableColumns" row-key="id" v-model:pagination="pagination"
                        :loading="loading" @request="onTableRequest" flat bordered selection="multiple"
                        v-model:selected="selectedPatients" class="export-table">
        ...
        <!-- Export Dialog -->
        <ExportDialog v-model="showExportDialog" :selected-patients="selectedPatients" :is-exporting="isExporting"
            @export="onExportDialogConfirm" @cancel="onExportDialogCancel" />
    </q-page>
</template>
