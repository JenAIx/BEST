...
| **number** | Zahl \| `null` (`parseFloat`, NaN→`null`) | numerischer String → Zahl normalisiert; NaN verworfen | summiert | `!= null` |
...
- **`seperator`**-Tippfehler wird neben `separator` toleriert (2 Alt-Bögen); neue Bögen: `separator`.
